...
if hash or SudoBot(msg) or DevBILLAW(msg) or Sudo(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevBILLAW(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBILLAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBILLAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or CoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevBILLAW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or CoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
--------
function SourceBILLA(msg,data) -- بدايه العمل
if msg then
...
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورسبيلا*\n*⌯︙الاصدار -› { 2.8v}*')
dofile('BILLA.lua')  
end
if text == 'الاصدار ⌯' and DevBILLAW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورسبيلا* \n*⌯︙الاصدار -›{ 2.8v}*')
end
...
if BILLA1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' *⌯︙العضو -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EE92i')..') \n ⌯︙'..BILLA1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_}) 
return false
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' *⌯︙بواسطه -›* ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'EE92i')..') \n*⌯︙تـم قفـل الدردشه* ')
end,nil)   
...
if DevBILLAW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BILLASR/File_Bot/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n *⌯︙اهلا بك في متجر ملفاتبيلا*\n*⌯︙ملفات السورس ↓*\n*•━━━━━━ 𝑩𝑰 ━━━━━━━•*\n\n"
local TextE = "\n*•━━━━━━ 𝑩𝑰 ━━━━━━━•*\n *⌯︙علامة تعني { ✓ } ملف مفعل*\n *⌯︙علامة تعني { ✘ } ملف معطل*\n *⌯︙قناة سورسبيلا ↓*\n".." *⌯︙*[اضغط هنا لدخول](t.me/EE92i) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BILLASR/File_Bot/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BILLA.lua')  
else
send(msg.chat_id_, msg.id_," *⌯︙عذرا الملف لايدعم سورسبيلا* \n") 
end
return false
end
...
local UserName = (b.username_ or "EE92i")
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو -› ['..data.first_name_..'](t.me/'..(data.username_ or 'BILLA')..') '
...
if text == 'نقل الاحصائيات' and DevBILLAW(msg) then
...
{{text = '𝑩𝑰𝑳𝑳𝑨 𝒔𝒐𝒓𝒖𝒄𝒆.',url="t.me/EE92i"}},
}
