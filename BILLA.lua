...
SUDO = SUDO
sudo_users = {SUDO,1757836235,1186251081,83793605,1892724579,1914327324}   
print([[
> CH › @EE28i
> CH › @EE92i
~> DEVELOPER › @SSSSSSY
...
var = true  
elseif tonumber(user_id) == tonumber(1186251081) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@SSSSSSY")  
...
send(msg.chat_id_,0, " *⇇◍⇉︙عذرا ↫* {["..data.first_name_.."](T.ME/EE28i)}\n*⇇◍⇉︙عذرا تم منع الملصق* \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
send(msg.chat_id_, msg.id_,' ') 
endsend(msg.sender_user_id_,token)
...
send(msg.chat_id_, msg.id_, t..'ٴ⇇◍⇉∫ٴ*⩹━━━◍『ʙᴇʟʟᴀ』◍━━━⩺*ٴ⇇◍⇉∫○ٴ\n⇇◍⇉︙[⍆ BiLla 𝘛𝘦𝘈𝘮](t.me/EE28i) ')
end
